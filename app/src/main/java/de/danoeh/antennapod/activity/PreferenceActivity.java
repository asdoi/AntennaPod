...
import de.danoeh.antennapod.fragment.preferences.PlaybackControlPreferencesFragment;
...
public class PreferenceActivity extends AppCompatActivity implements SearchPreferenceResultListener {
    ...
    private PreferenceFragmentCompat getPreferenceScreen(int screen) {
        ...
        } else if(screen == R.xml.preferences_playback_control){
            prefFragment = new PlaybackControlPreferencesFragment();
        }
        return prefFragment;
    }
    ...
    public static int getTitleOfPage(int preferences) {
        switch (preferences) {
            ...
            case R.xml.preferences_playback_control:
                return R.string.playback_control;
            default:
